...
namespace Zenject
{
    ...
    public class DiContainer : IInstantiator
    {
        ...
        internal GameObject CreateAndParentPrefab(
            ...
            InjectContext context, out bool shouldMakeActive, bool doLink = false)
        {
...
#endif
            {
                ...
                {
#if UNITY_EDITOR
                    gameObj = (GameObject)PrefabUtility.InstantiatePrefab(prefabAsGameObject);
                    positionAndRotationWereSet = false;
#else
                    throw new System.Exception("Unable to invoke Instantiate Prefab with linking in Build mode!");
#endif
                }
                else if (gameObjectBindInfo.Position.HasValue && gameObjectBindInfo.Rotation.HasValue)
                {
        ...
        public T InstantiatePrefabLinked<T>(UnityEngine.Object prefab) where T : MonoBehaviour
        {
            return InstantiatePrefab(
                prefab, GameObjectCreationParameters.Default, doLink: true).GetComponent<T>();
        }
        ...
        // Create a new game object from a prefab and fill in dependencies for all children
        public GameObject InstantiatePrefab(
            UnityEngine.Object prefab, GameObjectCreationParameters gameObjectBindInfo, bool doLink = false)
        {
            FlushBindings();

            bool shouldMakeActive;
            var gameObj = CreateAndParentPrefab(
                prefab, gameObjectBindInfo, null, out shouldMakeActive, doLink);
